...
%\index{Determinante!de Cayley--Menger}
%La fórmula de Herón puede escribirse en términos de un caso particular de un
%determinante de Cayley--Menger:
%\[
%	\frac14\sqrt{\det\begin{pmatrix}
%		0 & a^2 & b^2 & 1\\
%		a^2 & 0 & c^2 & 1\\
%		b^2 & c^2 & 0 & 1\\
%		1 & 1 & 1 & 0
...
%Brahmagupta demostró además que la diagonal $AC$ 
%\[
%	\sqrt{\frac{(ac+bd)(ad+bc)}{ab+cd}}.
%\]
...
%Para calcular
%valores de la tabla trigonométrica
%se utiliza la fórmula recursiva aproximada
%\[
%	\sin(n+1)a=2\sin (na)-\sin (n-1)a-\frac{\sin(na)}{r\sin a},
%\]
%donde 
%que implícitamente utiliza la aproximación $1-\cos a=1/450$, exacta hasta la 
...
1881.  
%En 1973 el matemático inglés Chisholm concibió una generalización 
%de las aproximaciones de Palé para funciones de dos variables. 
